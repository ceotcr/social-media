...
const SignInWithGitHub = () => {
    return (
        <div className='flex flex-col justify-center items-center gap-4'>
            ...
            } className="py-2 px-4 max-w-md flex justify-center items-center outline-1 outline outline-slate-400 hover:outline-slate-200 text-white w-full text-center text-base font-semibold shadow-md focus:outline-slate-200 rounded-lg transition-colors">
            ...
            <p className='text-xs text-gray-400 max-w-[320px] w-full text-center'
            >
